<template>
  <div :class="$_css.tableWrapper">
    <div class="vuetable-fixed-head-wrapper" v-if="isFixedHeader">
      <table>
        <vuetable-col-group :is-header="true"/>
        <thead :class="['vuetable-header', $_css.tableHeaderClass]">
    ...
    <div class="vuetable-body-wrapper" :class="[{'fixed-header' : isFixedHeader}, $_css.tableBodyWrapper]" :style="{height: tableHeight}">
      <table :class="['vuetable', isFixedHeader ? 'fixed-header' : '', $_css.tableClass]">
        <vuetable-col-group/>
        <thead v-if="!isFixedHeader" :class="['vuetable-header', $_css.tableHeaderClass]">
        <slot name="tableHeader" :fields="tableFields">
          <template v-for="(header, headerIndex) in headerRows">
            <component :is="header" :key="headerIndex"
                       @vuetable:header-event="onHeaderEvent"
        ...
        <tbody v-cloak :class="['vuetable-body', $_css.tableBodyClass]">
        ...
        <tfoot :class="['vuetable-footer', $_css.tableFooterClass]">
...
<script>
  ...
  import CssVuetifyUI from "./VuetableCssVuetifyUI";
  ...
  export default {
    ...
    methods: {
      ...
      mergeCss() {
        this.$_css = {...CssVuetifyUI.table, ...this.css}
      },
